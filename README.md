# **✨Online/Offline Budget-Tracker**✨</br>
...
```md
To install application run: npm i => npm start => open in browser.
```
...
```md
Once application is installed, simply use app by adding deposits and expenses and review data in chart to keep track of expenses.
```
...
```md
Simple to use budget-tracker by user adding transactions on input and keeping track on expenses.
```
...
```md
To contribute do a pull request and app is open for further development or to review any current bugs.
```
...
App Images:
![image](https://user-images.githubusercontent.com/84104912/145691584-6d1e97a9-6cf7-4183-9b54-c0b1af1949ae.png)
